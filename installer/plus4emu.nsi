...
;General
  ...
  ;Name and file
  Name "plus4emu"
  OutFile "plus4emu-1.2.5.3-beta.exe"
...
Section "Source code" SecSrc
  ...
  File "..\util\p4fliconv\hiresfli.cpp"
  File "..\util\p4fliconv\hiresfli.hpp"
  File "..\util\p4fliconv\hiresnofli.cpp"
  File "..\util\p4fliconv\hiresnofli.hpp"
  File "..\util\p4fliconv\hrbmifli.cpp"
  File "..\util\p4fliconv\hrbmifli.hpp"
  File "..\util\p4fliconv\imageconv.cpp"
  File "..\util\p4fliconv\imageconv.hpp"
  File "..\util\p4fliconv\imgwrite.cpp"
  File "..\util\p4fliconv\imgwrite.hpp"
  File "..\util\p4fliconv\interlace7.cpp"
  File "..\util\p4fliconv\interlace7.hpp"
  File "..\util\p4fliconv\main.cpp"
  File "..\util\p4fliconv\mcbmifli.cpp"
  File "..\util\p4fliconv\mcbmifli.hpp"
  File "..\util\p4fliconv\mcchar.cpp"
  File "..\util\p4fliconv\mcchar.hpp"
  File "..\util\p4fliconv\mcfli.cpp"
  File "..\util\p4fliconv\mcfli.hpp"
  File "..\util\p4fliconv\mcifli.cpp"
  File "..\util\p4fliconv\mcifli.hpp"
  ...
  File "..\util\p4fliconv\p4sconv.cpp"
  File "..\util\p4fliconv\p4slib.cpp"
  File "..\util\p4fliconv\p4slib.hpp"
