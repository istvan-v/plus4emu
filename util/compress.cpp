...
static const unsigned char decomp_code[0x020D] = {
  
};

static const unsigned char decomp_code_c16[0x0046] = {
  0x01, 0x10, 0x0B, 0x10, 0x0A, 0x00, 0x9E, 0x34, 0x31, 0x31, 0x31, 0x00,
  0x00, 0x00, 0x00, 0x40, 0x78, 0xD8, 0xA2, 0xFF, 0x9A, 0xAD, 0x06, 0xFF,
  0x48, 0xAD, 0x19, 0xFF, 0x48, 0xA0, 0x8E, 0xB9, 0x83, 0x10, 0x99, 0x24,
  0x01, 0xB9, 0x0D, 0x11, 0x99, 0x3A, 0x03, 0xB9, 0x7D, 0x11, 0x99, 0x71,
  0x09, 0x88, 0xD0, 0xEB, 0xA2, 0x01, 0xB5, 0x2D, 0x95, 0xDE, 0xBD, 0x0D,
  0x10, 0x95, 0x37, 0x95, 0xDA, 0x95, 0xDC, 0xCA, 0x10, 0xF0
};

static const unsigned char decomp_code_2[0x0027] = {
  0xA2, 0xFD, 0x9A, 0x68, 0x8D, 0x19, 0xFF, 0xAD, 0x3B, 0x05, 0x99, 0x00,
  0x08, 0x99, 0x00, 0x09, 0x99, 0x00, 0x0A, 0x99, 0x90, 0x0A, 0xC8, 0xD0,
...
static unsigned short lengthCodeTable[65536];
static unsigned char  lengthBitsTable[65536];

static void initializeLengthCodeTables()
{
  for (size_t i = 0; i < 65536; i++) {
    size_t  lCode = i;
    int     nBits = 0;
    while (lCode >= (size_t(1) << nBits)) {
      lCode -= (size_t(1) << nBits);
      nBits++;
    }
    lengthCodeTable[i] = (unsigned short) lCode;
    lengthBitsTable[i] = (unsigned char) nBits;
  }
}
...
static void writeRepeatCode(std::vector< unsigned int >& buf,
                            size_t d, size_t n)
{
  size_t  lCode = n - minRepeatLen;
  size_t  dCode = d - minRepeatDist;
  int     lBits = lengthBitsTable[lCode];
  int     dBits = lengthBitsTable[dCode];
  lCode = lengthCodeTable[lCode];
  dCode = lengthCodeTable[dCode];
  unsigned int  c =
      0x0100U | (unsigned int) lBits | ((unsigned int) dBits << 3);
  buf.push_back(c);
  if (lBits > 0)
    buf.push_back((unsigned int) ((lBits << 24) | lCode));
  if (dBits > 0)
    buf.push_back((unsigned int) ((dBits << 24) | dCode));
}

static inline size_t getRepeatCodeLength(size_t d, size_t n)
{
  int     lBits = lengthBitsTable[n - minRepeatLen];
  int     dBits = lengthBitsTable[d - minRepeatDist];
  return (repeatCodeBits + size_t(lBits + dBits));
}

static void writeSequenceCode(std::vector< unsigned int >& buf,
                              unsigned char seqDiff, size_t d, size_t n)
{
  ...
  dCode = lengthCodeTable[dCode];
  unsigned int  c =
      0x0180U | (unsigned int) lBits | ((unsigned int) dBits << 3);
  buf.push_back(c);
  seqDiff = (seqDiff + 0x20) & 0xFF;
  if (seqDiff > 0x20)
    seqDiff--;
  buf.push_back(0x06000000U | (unsigned int) seqDiff);
  if (lBits > 0)
    buf.push_back((unsigned int) ((lBits << 24) | lCode));
  if (dBits > 0)
    buf.push_back((unsigned int) ((dBits << 24) | dCode));
...
static inline size_t getSequenceCodeLength(size_t d, size_t n)
{
  int     lBits = lengthBitsTable[n - minRepeatLen];
  int     dBits = lengthBitsTable[d - minRepeatDist];
  return (repeatCodeBits + 9 + size_t(lBits + dBits));
}
    ...
    unsigned int startAddr, size_t offs, size_t nBytes)
{
  ...
  for (size_t i = offs; i < endPos; ) {
    ...
    long    bestComp = -1000L;
    bool    seqFlag = false;
    unsigned char seqDiff = 0x00;
    if (i >= minRepeatDist && (i + minRepeatLen) <= endPos) {
      for (size_t seqDist = 1; seqDist <= 3; seqDist++) {
        if (i >= seqDist) {
          unsigned char d = (inBuf[i] - inBuf[i - seqDist]) & 0xFF;
          if (d >= 0xE0 || d <= 0x20) {
            size_t  k = i;
            size_t  l = i - seqDist;
            while (k < endPos && (k - i) < maxRepeatLen &&
                   inBuf[k] == ((inBuf[l] + d) & 0xFF)) {
              k++;
              l++;
            }
            k = k - i;
            ...
            if (d != 0x00)
              minLen = minLen + ((seqDist - 1) << 2);
            if (k >= minLen) {
              long    tmp = long(k * bitsPerByte);
              if (d == 0x00)
                tmp -= long(getRepeatCodeLength(seqDist, k));
              else
                tmp -= long(getSequenceCodeLength(seqDist, k));
              if (tmp > bestComp) {
                bestPos = seqDist;
                bestLen = k;
                bestComp = tmp;
      ...
      if (bestLen < maxRepeatLen || seqFlag) {
        ...
        size_t  minLen = minRepeatLen;
        while (j < i) {
          size_t  k = i + minRepeatLen;
          size_t  l = j + minRepeatLen;
          while (k < endPos && inBuf[k] == inBuf[l] && (k - i) < maxRepeatLen) {
            k++;
            l++;
          }
          k -= i;
          if (k >= minLen) {
            size_t  d = i - j;
            long    tmp =
                long(k * bitsPerByte) - long(getRepeatCodeLength(d, k));
            if (tmp >= bestComp) {
              seqFlag = false;
              bestPos = d;
              bestLen = k;
    ...
    if (bestComp >= 0L) {
      if (seqFlag)
        writeSequenceCode(outBuf, seqDiff, bestPos, bestLen);
      else
...
int main(int argc, char **argv)
{
  ...
  if (!noDecompCode) {
    for (size_t i = 0; i < 0x020D; i++)
      outBuf.push_back(decomp_code[i]);
    if (c16Mode) {
      for (size_t i = 0; i < 0x0046; i++)
        outBuf[i] = decomp_code_c16[i];
    }
  }
  else {
    outBuf.push_back(0x0C);
  ...
  std::vector< unsigned char >  inBuf;
  {
    ...
    compressData(outBufTmp, tmpBuf, 0x03C9U);
  }
