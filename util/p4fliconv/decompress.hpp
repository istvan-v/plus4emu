...
#ifndef P4FLICONV_DECOMPRESS_HPP
#define P4FLICONV_DECOMPRESS_HPP
...
namespace Plus4FLIConv {
  ...
  class PRGDecompressor {
   private:
    static const unsigned char  sfxModuleLibrary[1788];
   ...
   public:
    PRGDecompressor();
    virtual ~PRGDecompressor();
    void decompressData(std::vector< std::vector< unsigned char > >& outBuf,
...
#endif  // P4FLICONV_DECOMPRESS_HPP
